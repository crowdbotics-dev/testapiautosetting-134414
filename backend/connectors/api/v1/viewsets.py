...
class Testconnectors134414ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134414_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134414_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134414"
